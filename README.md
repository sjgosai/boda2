...
[Preprint on bioRxiv](https://www.biorxiv.org/content/10.1101/2023.08.08.552077v1). For legacy reasons, this repo is currently listed as boda2. The code is covered by the AGPL-3.0 license, and the model and model weights are covered under the MIT license.
